...
game:GetService("TweenService"):Create(game.Lighting.Atmosphere, TweenInfo.new(3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {Density = 1}):Play()
game:GetService("TweenService"):Create(game.Lighting.Atmosphere, TweenInfo.new(3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {Haze = 10}):Play()
game:GetService("TweenService"):Create(game.Lighting.Atmosphere, TweenInfo.new(3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {Color = Color3.fromRGB(0, 0, 0)}):Play()
game:GetService("TweenService"):Create(game.Lighting.Atmosphere, TweenInfo.new(3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {Decay = Color3.fromRGB(0, 0, 0)}):Play()
game:GetService("TweenService"):Create(game.Lighting.Atmosphere, TweenInfo.new(3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {Offset = 0}):Play()
wait(4)
