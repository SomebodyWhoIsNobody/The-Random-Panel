...
local plrs = game:GetService("Players"):GetPlayers()
for _, i in plrs do
i.Character:WaitForChild("Hi").Enabled = true
end
end)
...
head.Position = Vector3.new(math.random(-200, 200), math.random(0, 100), math.random(-200, 200))
head.Anchored = true
...
local pathpos = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position - Vector3.new(0, 3, 0)
